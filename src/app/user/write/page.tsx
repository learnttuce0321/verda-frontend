...
export default function WritePostPage() {
  ...
  return (
    <>
      <Section>
        <TextStore textStyle={TextStyle.TEXT_R_40_BLUE} style="mb-[2.5rem]">투자문의 작성하기</TextStore>
      </Section>

      <section className="flex flex-col my-3">
        <InputTitle ref={titleRef} />
        <InputContent ref={contentRef} placeHolder="투자관련 문의를 작성해주세요" rows={23} />
      </section>

      <section className="mt-5">
        <ButtonButtonNavy>작성완료</ButtonButtonNavy>
      </section>
    </>
  )
}